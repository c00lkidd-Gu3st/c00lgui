...
local title = Instance.new("TextLabel")
	...
	title.Text = "c00lgui Reborn by c00lk1ddk1n9"
...
local Speed = "0.10" -- Set the speed of the orb's rotation. This is recommended.
...
local button = Instance.new("TextButton")
	...
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Kohls Admin (broken)"
	button.TextColor3 = whit
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Tptoplayer"
	button.Position = UDim2.new(0.5,3,0,165)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "TP to Player"
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
...
local button = Instance.new("TextButton")
	...
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Ctrl + Click TP"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/unrexl/UniversalScripts/refs/heads/main/Clickteleport"))()
	end)
--
local button = Instance.new("TextButton")
	button.Parent = acg
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Backflip"
	button.Position = UDim2.new(0.5,3,0,198)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Backflip (Z,X,B)"
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/YdnhLtkv"))()
	end)
-- Server Destruction --
local button = Instance.new("TextButton")
	button.Parent = sd
	...
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Xester v1"
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ilikeices/script/refs/heads/main/xester.luau"))()
	end)
--
local button = Instance.new("TextButton")
	button.Parent = sd
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "SuperRing"
	button.Position = UDim2.new(0,0,0,66)
	button.Size = UDim2.new(0.5,0,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "SuperRing Parts V5"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Jerktool"
	button.Position = UDim2.new(0.5,3,0,132)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Jerk off tool"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "BangScript"
	button.Position = UDim2.new(0,0,0,165)
	button.Size = UDim2.new(0.5,0,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Bang Player"
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "SeeingHand"
	button.Position = UDim2.new(0.5,3,0,132)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "All seeing hand"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
		warn("unworking so delete so you can't get banned!")
	end)
--
local button = Instance.new("TextButton")
	button.Parent = misc
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Jkrouz1/Fd/refs/heads/main/Pandora.txt"))()
	end)
--
local button = Instance.new("TextButton")
	button.Parent = misc
...
local button = Instance.new("TextButton")
	...
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Scary mario"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
		frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 118114437526100
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
...
local t3xt = Instance.new("TextLabel")
	...
	t3xt.Text = "Thank you for using c00lgui reborn go to youtube.com/@c00lkidd-Gu3st for more updates!"
